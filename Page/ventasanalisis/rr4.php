...
// Filtro por estilo
$filtro_estilo = isset($_POST['filtro_estilo']) ? $_POST['filtro_estilo'] : '';
...
<div class="reporte-container">
    ...
    <div class="filtros-section">
        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="filtro-container">
            <?php
            // Mantener los valores POST existentes
            ...
            <div class="filtro-grupo">
                ...
                <?php if (!empty($filtro_estilo)): ?>
                    <button type="submit" name="filtro_estilo" value="" class="btn-limpiar">🗑️ Limpiar Filtro</button>
                <?php endif; ?>
            </div>
        </form>
    </div>
